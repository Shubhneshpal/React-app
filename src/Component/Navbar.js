...
import { fetch_category, set_category } from '../Redux/Action.js/Action';
      ...
      <div className="col-lg-3 d-none d-lg-block">
        ...
        >
          <div className="navbar-nav w-100">
            ...
            {
              arr_category.map((item,index)=>(<div key={index} onClick={()=>{dispatch(set_category(item.toUpperCase()))}} className="nav-item nav-link">
              {item.toUpperCase()}
            </div>))
            }           
          </div>
